<div class="modal fade" id="modalCarga" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content border border-0" style="background: transparent !important">
            ...
            <div class="modal-body mb-0 pb-0 mt-0 pt-0">
                <h3 class="text-white d-flex justify-content-center" id="mensajeCarga">Espere un momento por favor</h3>
                <div class="d-flex justify-content-center">
                    <canvas class="animCarga"  style="width: 350px; height:250px"></canvas>
                </div>
            </div>
        </div>
    </div>
