...
<div class="container-fluid bg-white my-5 py-5">
    <div id="listaCasos" class="">
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-12 px-4 casoDatos DatosSup" >
                <div class="d-flex justify-content-between d-flex align-items-end">
                    <div>
                        <div style="font-size: 2rem">CASO A</div>
                    </div>
                    <div>
                        <i class="fas fa-clock-o"></i> <span>00:30:27</span> <small>Horas trabajadas</small>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-between">
            ...
            <button class="btn btn-sm mr-3" data-toggle="modal" data-target="#modalNuevoCaso"><i class="fas fa-plus-circle" style="font-size: 20px"></i></button>
        </div>
        <div class="my-4">
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="d-flex d-flex justify-content-between">
                        ...
                        <div class="text-right mt-4">
                            <button type="button" class="bg-blue px-4 py-2" style="border-radius: 5px; 5px; width: 20rem">Gestionar Caso</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-75 pt-2  casoDatos DatosInf shadow-sm "  style="height: 75vh; border:1px solid #f5f5f5; border-radius: 15px 15px">
...
<div class="chatbox-fixed" style="font-family: 'Montserrat'">
